function addtmpParam() {
    ...
    var methods = [
        {value: "selectbyvisibletext(下拉框的文本)"},
        {value: "selectbyvalue(下拉框的VALUE属性)"},
        {value: "selectbyindex(下拉框的index属性)"},
        {value: "isselect(下拉框是否已经被选择)"},
        // DropdownBox
    ...
    var actions = [
        ...
        {value: "gotowindow(切换到其他页签)"},
        {value: "closewindow(关闭当前浏览器窗口)"},
    ];
...
$("#subbtn").click(function () {
    ...
    $.getJSON("/sea/add_test_case_interface/", {"steps": JSON.stringify(RowArr),"case_name":case_name}, function (data) {
        if (data["status"] === 2000) {
